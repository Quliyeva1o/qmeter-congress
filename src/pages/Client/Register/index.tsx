  ...
  const formOptions: FormOption[] = [
    ...
    },
    {
      ...
      rules: [
        ...
        {
          pattern: /^\+\d+$/,
          message: "Əlaqə nömrəsi '+' işarəsi ilə başlamalıdır və rəqəm olmalıdır",
        },
        {
          validator: (_: any, value: string | any[]) => {
            if (value && value.length < 1) {
              return Promise.reject(new Error("Əlaqə nömrəsi ən azı 1 rəqəm olmalıdır."));
            }
            if (value && value.length > 15) {
              return Promise.reject(new Error("Əlaqə nömrəsi ən çox 15 rəqəm olmalıdır."));
            }
